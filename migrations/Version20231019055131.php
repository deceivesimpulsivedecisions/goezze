 ...
 */
final class Version20231019055131 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE package_destination (package_id INT NOT NULL, destination_id INT NOT NULL, INDEX IDX_F31D24CCF44CABFF (package_id), INDEX IDX_F31D24CC816C6140 (destination_id), PRIMARY KEY(package_id, destination_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
